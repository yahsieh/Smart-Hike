...
function TrailCard(props) {
    ...
    return (
        <>
            <Card id="card" style={{ padding: "15px", float: "left", cursor: "pointer" }} onClick={handleShow} >
                <Card.Img variant="top" src={props.img} height="180" width="240" onClick={handleTrailClick} />
                <Card.Body>
